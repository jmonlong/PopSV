...
##' @param file the name of the file which the data are to be read from. Should be compressed with |code{bgzip} and indexed by tabix algorithm.
##' @param subset a data.frame or GRanges object with the regions to subset from. If a data.frame, it must have columns named 'chr', 'start' and 'end'.
